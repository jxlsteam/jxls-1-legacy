...
This is a repo to keep Jxls 1.x source code.
Jxls 1.x is a legacy version of Jxls and is no longer supported.
Please migrate to Jxls-2 (https://github.com/jxlsteam/jxls).
---

jXLS - Export data to Excel using XLS template
===============================================
Online docs - http://jxls.sourceforge.net/1.x/
